...
#				libraries.apOff("hard", 0);
	...
	syncIAS: func() {
		Input.ias.setValue(math.clamp(math.round(Velocities.indicatedAirspeedKt.getValue()), 100, 330));
	},
	syncMach: func() {
		Input.mach.setValue(math.clamp(math.round(Velocities.indicatedMach.getValue(), 0.001), 0.5, 0.86));
	},
	syncHDG: func() {
