...
var rmpClass = {
	new: func(instance) {
		...
		if (instance == 1) {
			...
			m._prop_power_source = props.globals.getNode("systems/electrical/bus/dc-ess");
		} else if (instance == 2) {
			#m._prop_power_source = systems.ELEC.Bus.dc2;
			m._prop_power_source = props.globals.getNode("systems/electrical/bus/dc2");
		} else {
			#m._prop_power_source = systems.ELEC.Bus.dc1;
			m._prop_power_source = props.globals.getNode("systems/electrical/bus/dc1");
		}
		return m;
	},
	close: func() {
	...
	openDialog: func() {
		...
		canvas.parsesvg(me._svg, "Aircraft/Airbus_A330/gui/dialogs/rmp.svg");
